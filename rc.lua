...
for s = 1, screen.count() do
    ...
    wibox[s].widgets = {
        ...
        separator, dnicon.image and separator, upicon, netwidget, dnicon or nil,
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ },"XF86AudioMute", function() awful.util.spawn("amixer set Master toggle", false) end),
	awful.key({ "Mod4" }, "F6", function() awful.util.spawn("amixer set Master 1%+", false) end),
	awful.key({ "Mod4" }, "F5", function() awful.util.spawn("amixer set Master 1%-", false) end),
    -- Prompt
   ...
   -- switch focused application to neghbor workspaces
